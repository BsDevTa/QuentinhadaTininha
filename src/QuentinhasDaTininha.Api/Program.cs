...
using QuentinhasDaTininha.Infraestrutura.Bebidas.Servicos;
...
using QuentinhasDaTininha.Infraestrutura.ImpressoesPedidos.Servicos;
...
builder.Services.AddScoped<IServicoBebida, ServicoBebida>();
