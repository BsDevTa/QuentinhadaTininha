...
{
    /// <inheritdoc />
    public partial class SincronizarFreteCepAliasExistentes : Migration
    {
        /// <inheritdoc />
        ...
        {
            // Nao executar DROP TABLE automaticamente. Essas tabelas podem conter
            // dados de producao; remocao exige procedimento manual deliberado.
        }
    }
}
